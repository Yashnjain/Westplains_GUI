...
def fifo(input_date, output_date, location):
    ...
    for loc in location:
        ...
        # input_xl = r"J:\WEST PLAINS\REPORT\FIFO reports" +f"\\Sub_Loc_Mapping.xlsx"
        ...
        for key in columns_1.keys():
            ...
            new_sht = wb.sheets.add("HaySprings", after=wb.sheets[-1])
            ...
            if loc == "HRW":
                ...
                sub_loc = mtm_sht.range("B120:B124").value
